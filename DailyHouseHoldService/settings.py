"""
Django settings for DailyHouseHoldService project.
...
SECRET_KEY = '_l60$8bi0js^z5zwa)wsp@@-b5d719!8mihvzv8u_gxz0cb2=='
...
ROOT_URLCONF = 'DailyHouseHoldService.urls'
...
WSGI_APPLICATION = 'DailyHouseHoldService.wsgi.application'
